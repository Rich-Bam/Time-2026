...
const translations: Record<Language, Record<string, string>> = {
  nl: {
    ...
    // Export
    'export.title': 'Exporteer urenstaat gegevens',
    'export.description': 'Exporteer urenstaat gegevens naar Excel voor rapportage en analyse',
    ...
    'export.allData': 'Exporteer alle gegevens',
    'export.dateRange': 'Exporteer datumbereik',
    'export.weekNumber': 'Exporteer weeknummer',
    'export.perUser': 'Exporteer per gebruiker',
    ...
    'admin.totalHours': 'Totaal: {hours} uren ({entries} invoeren)',
    'admin.approveButton': 'Goedkeuren',
    'admin.rejectButton': 'Afwijzen',
    'admin.unlockButton': 'Ontgrendelen',
    'admin.viewUserWeeklyEntries': 'Bekijk wekelijkse invoeren',
    'admin.noConfirmedWeeks': 'Nog geen bevestigde weken.',
    'admin.noEntriesForUser': 'Geen invoeren gevonden voor deze gebruiker.',
    ...
    'admin.viewUserEntries': 'Bekijk wekelijkse invoeren',
    'admin.allConfirmedWeeks': 'Alle Bevestigde Weken',
    'admin.currentWeekSimpleUsers': 'Huidige Week',
    'admin.users': 'gebruikers',
    'admin.weeks': 'weken',
    'admin.withEntries': 'met invoeren',
    'admin.lateEntries': 'Achterstallige Wekelijkse Invoeren',
    'admin.noLateEntries': 'Geen achterstallige invoeren - alle weken zijn bijgewerkt!',
    'admin.selectAll': 'Selecteer Alles',
    'admin.selected': 'geselecteerd',
    'admin.daysLate': 'Dagen Te Laat',
    'admin.day': 'dag',
    'admin.days': 'dagen',
    'admin.lateEntriesUserFilter': 'Filter op Gebruiker',
    'admin.lateEntriesDateCutoff': 'Controleer Weken Terug',
    'admin.lastWeeks': 'Laatste {n} weken',
    'admin.allWeeks': 'Alle weken',
    'admin.dismissOverdue': 'Verwijderen uit lijst',
    'admin.dismissSelectedOverdue': 'Geselecteerde verwijderen uit lijst',
    'admin.dismissedOverdueSuccess': 'Invoeren verwijderd uit lijst',
    'admin.dismissedOverdueOne': '1 invoer verwijderd uit de achterstallige lijst.',
    'admin.dismissedOverdueCount': '{count} invoeren verwijderd uit de achterstallige lijst.',
    'admin.dismissedOverdueError': 'Verwijderen uit lijst mislukt.',
    'admin.reminderSent': 'Herinnering verzonden',
    'admin.sentOn': 'Verzonden op {date}',
    'admin.selectAtLeastOneLateEntry': 'Selecteer ten minste één achterstallige invoer om te verwijderen.',
    'admin.noSelection': 'Geen selectie',
    'admin.showInOverdueEntries': 'Toon in Achterstallige Invoeren',
    'admin.showInOverdueEntriesDescription': 'Of deze gebruiker moet worden gecontroleerd op achterstallige wekelijkse invoeren',
    ...
    'admin.searchWeeks': 'Zoek week, naam of e-mail',
    ...
    'overview.lastMonth': 'Vorige maand',
    'overview.last6Months': 'Afgelopen 6 maanden',
    'overview.last1Year': 'Afgelopen jaar',
    'overview.specificDay': 'Specifieke dag',
    'overview.dateRange': 'Datumbereik',
    'overview.pickDate': 'Kies datum',
    'overview.selectDateRange': 'Selecteer datumbereik',
    ...
    // Entry Sharing
    'share.share': 'Deel',
    'share.shareDay': 'Deel Dag',
    'share.shareWeek': 'Deel Week',
    'share.selectUser': 'Selecteer Gebruiker',
    'share.searchUser': 'Zoek gebruiker...',
    'share.noUserFound': 'Geen gebruiker gevonden.',
    'share.message': 'Bericht (optioneel)',
    'share.messagePlaceholder': 'Voeg een bericht toe...',
    'share.entriesCount': '{count} invoer(en)',
    'share.shareButton': 'Deel',
    'share.sharing': 'Delen...',
    'share.shared': 'Gedeeld',
    'share.sharedSuccess': 'Succesvol gedeeld',
    'share.sharedSuccessDescription': 'Je invoeren zijn gedeeld met {name}',
    'share.shareError': 'Fout bij delen',
    'share.shareErrorDescription': 'Kon invoeren niet delen: {error}',
    'share.noEntries': 'Geen invoeren',
    'share.noEntriesDescription': 'Je hebt geen invoeren voor deze dag/week om te delen.',
    'share.futureDateError': 'Kan niet delen',
    'share.futureDateErrorDescription': 'Je kunt alleen invoeren delen voor huidige of verleden weken.',
    'share.alreadyShared': 'Al gedeeld',
    'share.alreadySharedDescription': 'Deze dag/week is al gedeeld met deze gebruiker.',
    'share.pendingShares': 'In Afwachting',
    'share.pendingSharesTitle': 'Gedeelde Invoeren',
    'share.pendingSharesDescription': 'Invoeren die met jou gedeeld zijn',
    'share.noPendingShares': 'Geen gedeelde invoeren',
    'share.sharedBy': 'Gedeeld door {name}',
    'share.sharedDate': 'Datum: {date}',
    'share.sharedWeek': 'Week: {week}',
    'share.entriesPreview': '{count} invoer(en)',
    'share.accept': 'Accepteren',
    'share.decline': 'Afwijzen',
    'share.accepting': 'Accepteren...',
    'share.declining': 'Afwijzen...',
    'share.accepted': 'Geaccepteerd',
    'share.acceptedDescription': 'Gedeelde invoeren zijn toegevoegd aan je timesheet.',
    'share.declined': 'Afgewezen',
    'share.declinedDescription': 'Gedeelde invoeren zijn afgewezen.',
    'share.acceptError': 'Fout bij accepteren',
    'share.acceptErrorDescription': 'Kon gedeelde invoeren niet accepteren: {error}',
    'share.overwriteConfirm': 'Bestaande Invoeren Vervangen?',
    'share.overwriteConfirmDescription': 'Je hebt al invoeren voor {date}. Accepteren zal deze vervangen. Doorgaan?',
    'share.previewEntries': 'Voorbeeld Invoeren',
    'share.close': 'Sluiten',
    'share.selectDays': 'Selecteer Dagen om te Delen',
    'share.selectDaysDescription': 'Kies welke dagen van de week je wilt delen',
    'share.selectedDaysCount': '{count} dag(en) geselecteerd',
  ...
  en: {
    ...
    'admin.lateEntries': 'Overdue Weekly Entries',
    'admin.noLateEntries': 'No late entries - all weeks are up to date!',
    'admin.selectAll': 'Select All',
    'admin.selected': 'selected',
    'admin.daysLate': 'Days Late',
    'admin.day': 'day',
    'admin.days': 'days',
    'admin.lateEntriesUserFilter': 'Filter by User',
    'admin.lateEntriesDateCutoff': 'Check Weeks Back',
    'admin.lastWeeks': 'Last {n} weeks',
    'admin.allWeeks': 'All weeks',
    'admin.dismissOverdue': 'Dismiss',
    'admin.dismissSelectedOverdue': 'Dismiss selected',
    'admin.dismissedOverdueSuccess': 'Entries Dismissed',
    'admin.dismissedOverdueOne': '1 entry removed from the overdue list.',
    'admin.dismissedOverdueCount': '{count} entries removed from the overdue list.',
    'admin.dismissedOverdueError': 'Failed to dismiss entries.',
    'admin.reminderSent': 'Reminder sent',
    'admin.sentOn': 'Sent on {date}',
    'admin.selectAtLeastOneLateEntry': 'Please select at least one late entry to dismiss.',
    'admin.noSelection': 'No Selection',
    'admin.showInOverdueEntries': 'Show in Overdue Entries',
    'admin.showInOverdueEntriesDescription': 'Whether this user should be checked for overdue weekly entries',
    ...
    'overview.last1Year': 'Last year',
    'overview.specificDay': 'Specific day',
    'overview.dateRange': 'Date range',
    'overview.pickDate': 'Pick date',
    'overview.selectDateRange': 'Select date range',
    ...
    // Entry Sharing
    'share.share': 'Share',
    'share.shareDay': 'Share Day',
    'share.shareWeek': 'Share Week',
    'share.selectUser': 'Select User',
    'share.searchUser': 'Search user...',
    'share.noUserFound': 'No user found.',
    'share.message': 'Message (optional)',
    'share.messagePlaceholder': 'Add a message...',
    'share.entriesCount': '{count} entry(ies)',
    'share.shareButton': 'Share',
    'share.sharing': 'Sharing...',
    'share.shared': 'Shared',
    'share.sharedSuccess': 'Successfully Shared',
    'share.sharedSuccessDescription': 'Your entries have been shared with {name}',
    'share.shareError': 'Share Error',
    'share.shareErrorDescription': 'Could not share entries: {error}',
    'share.noEntries': 'No Entries',
    'share.noEntriesDescription': 'You have no entries for this day/week to share.',
    'share.futureDateError': 'Cannot Share',
    'share.futureDateErrorDescription': 'You can only share entries for current or past weeks.',
    'share.alreadyShared': 'Already Shared',
    'share.alreadySharedDescription': 'This day/week has already been shared with this user.',
    'share.pendingShares': 'Pending Shares',
    'share.pendingSharesTitle': 'Shared Entries',
    'share.pendingSharesDescription': 'Entries that have been shared with you',
    'share.noPendingShares': 'No shared entries',
    'share.sharedBy': 'Shared by {name}',
    'share.sharedDate': 'Date: {date}',
    'share.sharedWeek': 'Week: {week}',
    'share.entriesPreview': '{count} entry(ies)',
    'share.accept': 'Accept',
    'share.decline': 'Decline',
    'share.accepting': 'Accepting...',
    'share.declining': 'Declining...',
    'share.accepted': 'Accepted',
    'share.acceptedDescription': 'Shared entries have been added to your timesheet.',
    'share.declined': 'Declined',
    'share.declinedDescription': 'Shared entries have been declined.',
    'share.acceptError': 'Accept Error',
    'share.acceptErrorDescription': 'Could not accept shared entries: {error}',
    'share.overwriteConfirm': 'Replace Existing Entries?',
    'share.overwriteConfirmDescription': 'You already have entries for {date}. Accepting will replace them. Continue?',
    'share.previewEntries': 'Preview Entries',
    'share.close': 'Close',
    'share.selectDays': 'Select Days to Share',
    'share.selectDaysDescription': 'Choose which days of the week you want to share',
    'share.selectedDaysCount': '{count} day(s) selected',
